...
def run_run(args: argparse.Namespace, client_factory=KStartupClient) -> int:
    """수집과 판정을 연속 수행한다."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    run_parser.add_argument("--page", type=int, default=1, help="페이지 번호 (기본 1)")
    run_parser.add_argument("--per-page", type=int, default=5, help="페이지당 결과 수 (기본 5)")
    run_parser.add_argument("--no-save", action="store_true", help="원본 응답을 저장하지 않음")
